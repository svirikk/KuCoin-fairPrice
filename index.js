...
function logStats() {
  ...
  if (state.stats.ticker === 0) console.warn('[WARN] tickerV2: 0 msgs — підписка не працює!');
  if (state.stats.instrument === 0) console.warn('[WARN] instrument: 0 msgs — підписка не працює!');
